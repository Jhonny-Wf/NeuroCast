...
Un fisier de date exemplu (cu date fictive) este inclus in repository pentru testare rapida.

<!-- NOTA: daca adaugi un fisier exemplu, mentioneaza aici numele lui, ex: date_test_exemplu.xlsx -->
